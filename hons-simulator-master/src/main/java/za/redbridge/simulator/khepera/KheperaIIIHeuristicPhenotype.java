 ...
 */
public abstract class KheperaIIIHeuristicPhenotype implements Phenotype {
     ...
     */
    public KheperaIIIHeuristicPhenotype() {
     ...
     * configuration.
     */
    public KheperaIIIHeuristicPhenotype(Configuration config) {
...
/*    @Override
    ...
    // end heuristic configs

    @Override
    public KheperaIIIHeuristicPhenotype clone() throws UnsupportedOperationException {
